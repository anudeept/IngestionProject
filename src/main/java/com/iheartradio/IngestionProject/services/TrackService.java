...
public class TrackService {
    ...
    private static final org.slf4j.Logger log = LoggerFactory.getLogger(TrackService.class);

    @Autowired
    public TrackService(MongoTemplate mongoTemplate, TrackSearch_Service_Redis_Impl searchServiceRedis) {
